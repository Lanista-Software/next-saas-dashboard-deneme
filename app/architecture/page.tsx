...
export default async function ArchitecturePage() {
  ...
  return (
    <DashboardShell
      ...
      kicker="Architecture"
      title="Dashboard copy is only useful when the content model is explicit."
      description="This page reads the local Contentrain model files and shows how system, app, and ops domains map to real product surfaces."
    >
