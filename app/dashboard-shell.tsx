    ...
    <div className="dashboard-app">
      <aside className="sidebar">
        ...
        <div className="sidebar-panel">
          <div className="eyebrow">{copy.get("surface.caption") ?? "Typed product content"}</div>
          <p className="muted">{copy.get("surface.note") ?? "Move volatile UI text out of components."}</p>
